        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            <div className="flex items-center">
              <Logo width="120px" className="filter brightness-0 invert" />
            </div>
            <p className="text-neutral-300 text-sm leading-relaxed">
              Share your thoughts with the world. Create, publish, and connect through meaningful content.
            </p>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link className="text-neutral-300 hover:text-primary-400 transition-colors duration-300 text-sm" to="/">
                  Features
                </Link>
              </li>
              <li>
